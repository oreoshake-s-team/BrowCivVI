...
const HEXES: readonly MapHex[] = [
  ...
  h(7, 0, "coast"), h(8, 0, "plains", "cyzicus"), h(9, 0, "deepSea"),
  h(0, 1, "plains", "pella"), h(1, 1, "plains"), h(2, 1, "plains", "amphipolis"),
  h(3, 1, "coast"), h(4, 1, "coast"), h(5, 1, "plains"), h(6, 1, "plains"),
  h(7, 1, "plains", "zeleia"), h(8, 1, "plains", "dascylium"), h(9, 1, "hills"),
  h(0, 2, "hills"), h(1, 2, "plains"), h(2, 2, "coast"), h(3, 2, "plains", "elaeus"),
  ...
  h(4, 3, "plains"), h(5, 3, "coast"), h(6, 3, "hills"), h(7, 3, "hills"),
  h(8, 3, "plains"), h(9, 3, "hills"),
  h(0, 4, "hills"), h(1, 4, "hills"), h(2, 4, "plains"), h(3, 4, "plains"),
  h(4, 4, "deepSea"), h(5, 4, "coast"), h(6, 4, "mountain"), h(7, 4, "mountain"),
  h(8, 4, "hills", "sardis"), h(9, 4, "hills"),
  h(0, 5, "hills"), h(1, 5, "hills"), h(2, 5, "plains", "athens"), h(3, 5, "deepSea"),
  h(4, 5, "deepSea"), h(5, 5, "deepSea"), h(6, 5, "hills"), h(7, 5, "plains"),
  h(8, 5, "plains"), h(9, 5, "hills"),
  h(0, 6, "hills"), h(1, 6, "plains", "corinth"), h(2, 6, "hills"), h(3, 6, "deepSea"),
  h(4, 6, "deepSea"), h(5, 6, "deepSea"), h(6, 6, "plains", "ephesus"), h(7, 6, "plains"),
  h(8, 6, "hills"), h(9, 6, "hills"),
  h(0, 7, "mountain"), h(1, 7, "hills"), h(2, 7, "hills"), h(3, 7, "deepSea"),
  h(4, 7, "deepSea"), h(5, 7, "deepSea"), h(6, 7, "coast"), h(7, 7, "plains"),
  h(8, 7, "hills"), h(9, 7, "hills"),
  h(0, 8, "hills"), h(1, 8, "hills", "sparta"), h(2, 8, "hills"), h(3, 8, "deepSea"),
  h(4, 8, "deepSea"), h(5, 8, "deepSea"), h(6, 8, "plains", "miletus"), h(7, 8, "plains"),
  h(8, 8, "hills"), h(9, 8, "deepSea"),
  h(0, 9, "deepSea"), h(1, 9, "hills"), h(2, 9, "coast"), h(3, 9, "deepSea"),
  h(4, 9, "deepSea"), h(5, 9, "deepSea"), h(6, 9, "deepSea"), h(7, 9, "plains", "halicarnassus"),
  h(8, 9, "deepSea"), h(9, 9, "deepSea"),
];
...
export const FIRST_SLICE_REGIONS: readonly NamedRegion[] = [
  ...
  island("euboea", "Euboea", 3, 4, "Euboea, the long island hugging central Greece, is the second-largest Greek island.", "Euboea", "https://en.wikipedia.org/wiki/Euboea"),
  island("lesbos", "Lesbos", 4, 3, "Lesbos, the large island off the Troad, is the third-largest Greek island.", "Lesbos", "https://en.wikipedia.org/wiki/Lesbos"),
];
